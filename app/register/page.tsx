    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <Card className="border shadow-lg">
        <CardHeader className="space-y-1 pb-4">
          <CardTitle className="text-2xl font-semibold">Hesap Oluştur</CardTitle>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="adSoyad" className="text-sm">Ad Soyad</Label>
              <Input
                id="adSoyad"
                {...register('adSoyad')}
            ...
            <div className="space-y-1.5">
              <Label htmlFor="eposta" className="text-sm">E-posta</Label>
              <Input
                id="eposta"
                type="email"
                {...register('eposta')}
              ...
              {errors.eposta && (
                <p className="text-xs text-red-500">
                  {errors.eposta.message}
                </p>
              )}
            </div>

            <div className="space-y-1.5">
              <Label htmlFor="telNo" className="text-sm">Telefon No</Label>
              <Input
                id="telNo"
                {...register('telNo')}
            ...
            <div className="space-y-1.5">
              <Label htmlFor="dogumTarihi" className="text-sm">Doğum Tarihi</Label>
              <Input
                id="dogumTarihi"
                type="date"
            ...
            <div className="space-y-1.5">
              <Label htmlFor="sifreTekrar" className="text-sm">Şifre Tekrar</Label>
              <Input
                id="sifreTekrar"
                type="password"
